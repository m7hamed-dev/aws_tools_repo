...
final lightTheme = ThemeData(
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    unselectedLabelStyle: maraiRegular.copyWith(fontSize: 14.0),
  ...
  inputDecorationTheme: InputDecorationTheme(
    helperStyle: maraiBold.copyWith(color: Colors.pink.withOpacity(.22)),
    hintStyle: maraiRegular.copyWith(color: Colors.grey),
    // labelStyle: maraiBlack.copyWith(color: Colors.green),
    errorStyle: maraiBold.copyWith(fontSize: 13.0),
    ...
    activeIndicatorBorder: const BorderSide(width: 10, color: Colors.yellow),
  ),
