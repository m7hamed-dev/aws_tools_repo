...
final darkTheme = ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    helperStyle: maraiBold.copyWith(color: Colors.white.withOpacity(.22)),
    hintStyle: maraiBold.copyWith(color: Colors.white.withOpacity(.22)),
    //  hintStyle: maraiBold.copyWith(color: Colors.grey),
    labelStyle: maraiBlack.copyWith(color: Colors.white),
    errorStyle: maraiRegular,
